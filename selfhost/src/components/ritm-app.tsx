...
function Profile({user,avatar,streak,onOpenMaker,onOpenOnboarding}:{user:{name:string;email:string;username?:string|null};avatar?:Partial<AvatarConfig>|null;streak:number;onOpenMaker:()=>void;onOpenOnboarding:()=>void}) {
  ...
  return <section className="screen">
    ...
    <div className="profile-menu">
      ...
      <details className="profile-group" name="profile-settings"><summary><span>📏</span><div><b>Замеры тела</b><small>Талия, живот, бёдра, бедро, рука, грудь</small></div><i>›</i></summary><div className="profile-group-content"><MeasurementsCard/></div></details>
